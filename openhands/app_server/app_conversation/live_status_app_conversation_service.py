...
class LiveStatusAppConversationService(AppConversationServiceBase):
    ...
    async def _build_start_conversation_request_for_user(
        ...
        # Resolve llm_base_url based on model and environment
        resolved_llm_base_url = self.resolve_llm_base_url(model, self.web_url)

        llm_base_url = resolved_llm_base_url or user.llm_base_url
